...
class Matrix {
 ...
 public:
  ...
  Matrix(const Matrix& rhs); //removed "= default"

  int getNumRows() const;  //getter for private member variable "numRows"
  int getNumCols() const;  //getter for private member variable "numCols"
  ...
  //std::ifstream data;
  std::vector<std::vector<double> > our_matrix;
  int numRows;
  int numCols;
  double valOfElement;
